...
class TestConfig:
    def test_default_config(self) -> None:
        ...
        assert config.agentic.code_skeleton_enabled is True  # Base default; balanced profile overrides to False
        ...
        assert config.agentic.quality_guard_enabled is True
        assert config.agentic.quality_guard_alpha == 0.3
        assert config.agentic.quality_guard_critical_threshold == 0.3
        assert config.agentic.quality_guard_degraded_threshold == 0.55
        assert config.agentic.quality_guard_healthy_threshold == 0.75
