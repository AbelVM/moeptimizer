# SYSTEM ARCHITECTURE REVIEW REQUEST for a Transparent OpenAI API proxy that optimizes context for MoE + MTP models in multi-turns agentic tasks.
...
- The mission of this proxy is to improve speed and quality of the inference using MoE-MTP models (not only Qwen3.6-35B-A3B-MTP) in local, hardware limited setups
- Typical use is multi-turns agentic coding tasks (debug, refactor, review, etc.)
- In terms of speed, both tps and ttft are important
